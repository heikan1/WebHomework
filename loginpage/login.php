    ...
    if($_POST["email"] == $correctEmail && $_POST["password"] == $correctPassword ){
            ...
            echo 'maili boş geçemezsiniz';
            echo '10 saniye sonra hakkında sayfasına yönlendirileceksiniz';
            header('Refresh: 5; URL=http://metinhakanyilmaz.great-site.net/hakkindapage/index.html'); 
    }
    else if($_POST["password"] == ""){
        echo 'şifreyi boş geçemezsiniz';
        echo '10 saniye sonra login sayfasına yönlendirileceksiniz';
